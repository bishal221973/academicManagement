...
<template>
    <div style="width: 400px;">
        <div class="p-3 rounded bg-white shadow" style="min-height: calc(100vh - 110px);">
            ...
            <div style="height: calc(100vh - 390px);overflow-y: auto;">
                ...
                <div v-for="item in orderList" :key="item.id"
                    ...
                    <div class="flex items-center gap-2">
                        <button class="px-2 py-1 bg-gray-200 rounded" @click="decrease(item.id)">-</button>
                        <span>{{ item.qty }}</span>
                        <!-- {{ item?.qty1 }} -->
                        <button class="px-2 py-1 bg-gray-200 rounded" @click="increase(item.id,item.qty1)">+</button>
                    </div>
           ...
           <form @submit.prevent="saveData">
             <div class="block mt-3">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <div class="flex items-center">
                        ...
                        <Toggle v-model="form.is_percentage" :onColor="'#fff'" :offColor="'#ccc'" class="relative top-[2px]" />
            ...
            <div class="block mt-3 bg-gray-100 p-3 rounded">
                ...
                <button  class="w-full mt-3 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" type="submit">
                    Save
                </button>
