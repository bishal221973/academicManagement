...
<template>
    <div class=" p-3 rounded-md shadow-md bg-blue-50">
        <div class="flex items-center gap-3">
            <div>
                <i class="fa fa-money-bill-transfer text-[50px] text-blue-300"></i>
            ...
            <div class="block">
                ...
                <span class="text-[20px] bold font-bold text-blue-400">
                    Rs. {{ totalAmount }}
                </span>
            </div>
        </div>
